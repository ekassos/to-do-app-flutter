          ...
          return ListView(
            children: [
              Row(
                ...
                child: Text('Overview',style: Theme.of(context).textTheme.headline4,),
              ),
              ],),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    status(Colors.red, livetasks, 'Pending tasks', context),
                    status(Colors.green, completedTasks, 'Completed tasks', context),
                    status(Colors.blue, createdTasks, 'Total tasks created', context)
                  ],
                ),
              ),
                  ...
                  child: CircularStepProgressIndicator(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("of completed tasks",style: Theme.of(context).textTheme.headline2,)
                      ],
                    ),
                  ),
                ),
