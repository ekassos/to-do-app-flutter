                ...
                children: [
                    ...
                    child: TextFormField(
                      ...
                      validator: (value){
                        if(value==null||value.trim().isEmpty){
                          return 'Enter the item category you want to create to continue';
                        }
                        return null;
                      },
                    ),
                  ...
                  SizedBox(width: 40.0.wp,height: 6.0.hp, child: ElevatedButton(onPressed: (){
                    if(homecontrol.formkey.currentState!.validate()){
                      ...
                      Get.back();
                      homecontrol.addTask(task)?EasyLoading.showSuccess('Successfully created item category'):EasyLoading.showError('Duplicate item category');
                    }
                  }, child: Text("Confirm")))
                ],
              ))
